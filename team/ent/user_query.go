...
type UserQuery struct {
	...
	withAllowlistAdded *AllowlistEntryQuery
	withChatsCreated   *ChatQuery
	withMemberships    *ChatMemberQuery
	withMessages       *MessageQuery
	withAgentsCreated  *AgentQuery
	withAgentRoles     *AgentRoleQuery
...
func (_q *UserQuery) QueryAuthSessions() *AuthSessionQuery {
	query := (&AuthSessionClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *UserQuery) QueryAllowlistAdded() *AllowlistEntryQuery {
	query := (&AllowlistEntryClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *UserQuery) QueryAgentRoles() *AgentRoleQuery {
	query := (&AgentRoleClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *UserQuery) Clone() *UserQuery {
	...
	return &UserQuery{
		...
		withAllowlistAdded: _q.withAllowlistAdded.Clone(),
		withChatsCreated:   _q.withChatsCreated.Clone(),
		withMemberships:    _q.withMemberships.Clone(),
		withMessages:       _q.withMessages.Clone(),
		withAgentsCreated:  _q.withAgentsCreated.Clone(),
		withAgentRoles:     _q.withAgentRoles.Clone(),
...
// WithAllowlistAdded tells the query-builder to eager-load the nodes that are connected to
// the "allowlist_added" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *UserQuery) WithAllowlistAdded(opts ...func(*AllowlistEntryQuery)) *UserQuery {
	query := (&AllowlistEntryClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withAllowlistAdded = query
	return _q
}

// WithChatsCreated tells the query-builder to eager-load the nodes that are connected to
// the "chats_created" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *UserQuery) WithChatsCreated(opts ...func(*ChatQuery)) *UserQuery {
	query := (&ChatClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withChatsCreated = query
	return _q
}
...
// WithAgentsCreated tells the query-builder to eager-load the nodes that are connected to
// the "agents_created" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *UserQuery) WithAgentsCreated(opts ...func(*AgentQuery)) *UserQuery {
	query := (&AgentClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withAgentsCreated = query
	return _q
}

// WithAgentRoles tells the query-builder to eager-load the nodes that are connected to
// the "agent_roles" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *UserQuery) WithAgentRoles(opts ...func(*AgentRoleQuery)) *UserQuery {
	query := (&AgentRoleClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withAgentRoles = query
	return _q
}
...
func (_q *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	var (
		...
		loadedTypes = [8]bool{
			...
			_q.withAllowlistAdded != nil,
			_q.withChatsCreated != nil,
			_q.withMemberships != nil,
			_q.withMessages != nil,
			_q.withAgentsCreated != nil,
			_q.withAgentRoles != nil,
		}
	)
	...
	if query := _q.withAuthSessions; query != nil {
	...
	if query := _q.withAllowlistAdded; query != nil {
		if err := _q.loadAllowlistAdded(ctx, query, nodes,
			func(n *User) { n.Edges.AllowlistAdded = []*AllowlistEntry{} },
			func(n *User, e *AllowlistEntry) { n.Edges.AllowlistAdded = append(n.Edges.AllowlistAdded, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withChatsCreated; query != nil {
		if err := _q.loadChatsCreated(ctx, query, nodes,
			func(n *User) { n.Edges.ChatsCreated = []*Chat{} },
			func(n *User, e *Chat) { n.Edges.ChatsCreated = append(n.Edges.ChatsCreated, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withMemberships; query != nil {
		if err := _q.loadMemberships(ctx, query, nodes,
			func(n *User) { n.Edges.Memberships = []*ChatMember{} },
			func(n *User, e *ChatMember) { n.Edges.Memberships = append(n.Edges.Memberships, e) }); err != nil {
			return nil, err
		}
	}
	...
	if query := _q.withAgentsCreated; query != nil {
		if err := _q.loadAgentsCreated(ctx, query, nodes,
			func(n *User) { n.Edges.AgentsCreated = []*Agent{} },
			func(n *User, e *Agent) { n.Edges.AgentsCreated = append(n.Edges.AgentsCreated, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withAgentRoles; query != nil {
		if err := _q.loadAgentRoles(ctx, query, nodes,
			func(n *User) { n.Edges.AgentRoles = []*AgentRole{} },
			func(n *User, e *AgentRole) { n.Edges.AgentRoles = append(n.Edges.AgentRoles, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *UserQuery) loadIdentities(ctx context.Context, query *IdentityQuery, nodes []*User, init func(*User), assign func(*User, *Identity)) error {
...
func (_q *UserQuery) loadAuthSessions(ctx context.Context, query *AuthSessionQuery, nodes []*User, init func(*User), assign func(*User, *AuthSession)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
...
func (_q *UserQuery) loadAllowlistAdded(ctx context.Context, query *AllowlistEntryQuery, nodes []*User, init func(*User), assign func(*User, *AllowlistEntry)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(allowlistentry.FieldAddedBy)
	}
	query.Where(predicate.AllowlistEntry(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.AllowlistAddedColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *UserQuery) loadChatsCreated(ctx context.Context, query *ChatQuery, nodes []*User, init func(*User), assign func(*User, *Chat)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(chat.FieldCreatedBy)
	}
	query.Where(predicate.Chat(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.ChatsCreatedColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *UserQuery) loadMemberships(ctx context.Context, query *ChatMemberQuery, nodes []*User, init func(*User), assign func(*User, *ChatMember)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(chatmember.FieldUserID)
	}
...
func (_q *UserQuery) loadMessages(ctx context.Context, query *MessageQuery, nodes []*User, init func(*User), assign func(*User, *Message)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(message.FieldAuthorUserID)
	}
	...
	for _, n := range neighbors {
		fk := n.AuthorUserID
		if fk == nil {
			return fmt.Errorf(`foreign-key "author_user_id" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
...
func (_q *UserQuery) loadAgentsCreated(ctx context.Context, query *AgentQuery, nodes []*User, init func(*User), assign func(*User, *Agent)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.Where(predicate.Agent(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.AgentsCreatedColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *UserQuery) loadAgentRoles(ctx context.Context, query *AgentRoleQuery, nodes []*User, init func(*User), assign func(*User, *AgentRole)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(agentrole.FieldUserID)
	}
	query.Where(predicate.AgentRole(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.AgentRolesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
