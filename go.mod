...
require (
	...
	github.com/plexusone/omni-twilio v0.5.0 // indirect
	github.com/plexusone/omnivoice-core v0.9.0 // indirect
	...
	github.com/team-telnyx/telnyx-go/v4 v4.71.0 // indirect
...
// Pin jsonschema to v0.13.0 for compatibility with anthropic-sdk-go v1.45.0.
// jsonschema v0.14.0 switched from wk8/go-ordered-map/v2 to pb33f/ordered-map/v2,
// which is type-incompatible with anthropic-sdk-go's use of wk8/go-ordered-map/v2.
// Remove this replace directive when anthropic-sdk-go updates to pb33f/ordered-map.
